            ...
            <form className="w-full flex flex-col gap-6" id="inquiry-form" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-6 md:gap-x-8 md:gap-y-8 w-full">
                ...
                <div className="form-group relative flex flex-col group col-span-2">
                  ...
                  <div className="absolute right-0 bottom-2 md:bottom-3 pointer-events-none text-xbd-gold opacity-50">
        ...
        <footer ref={footerRef} className="absolute top-0 left-0 w-full h-full flex flex-col justify-between pt-16 pb-12 px-6 md:px-12 text-white">
          ...
          <div className="relative z-10 w-full h-full flex flex-col justify-between pt-8">
            ...
            <div className="w-full flex flex-col md:flex-row gap-12 md:gap-32">
              ...
              >
                <span className="font-sans text-[9px] font-medium tracking-[0.2em] text-xbd-gold uppercase group-hover:text-white transition-colors">Dubai HQ</span>
                <span className="font-display text-base md:text-lg font-light tracking-wide opacity-80 leading-relaxed group-hover:opacity-100 transition-opacity">
                  Suites 207 & 208, B-Wing, Building 06<br/>
                  Dubai Design District, 333253<br/>
                  Dubai, UAE
                </span>
                <a href="https://maps.google.com/?q=Dubai+Design+District" target="_blank" rel="noreferrer" className="font-sans text-[10px] font-medium underline tracking-wider mt-2 opacity-60 group-hover:opacity-100 transition-opacity">Get Direction</a>
              </div>
              <div 
                className="flex flex-col gap-3 group cursor-pointer"
                ...
                onMouseLeave={() => handleHover(null)}
              >
                <span className="font-sans text-[9px] font-medium tracking-[0.2em] text-xbd-gold uppercase group-hover:text-white transition-colors">London</span>
                <span className="font-display text-base md:text-lg font-light tracking-wide opacity-80 leading-relaxed group-hover:opacity-100 transition-opacity">
                  7 New Quebec St<br/>
                  Marylebone, W1H 7RH<br/>
                  London, UK
                </span>
                <a href="https://maps.google.com/?q=7+New+Quebec+St,+Marylebone,+London" target="_blank" rel="noreferrer" className="font-sans text-[10px] font-medium underline tracking-wider mt-2 opacity-60 group-hover:opacity-100 transition-opacity">Get Direction</a>
              </div>
            </div>
