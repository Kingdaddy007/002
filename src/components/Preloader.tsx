...
const FRAGMENT_SHADER = `
  ...
  vec3 permute(vec3 x) { return mod289(((x * 34.0) + vec3(1.0)) * x); }
  ...
  void main() {
    ...
    float n1 = snoise(v_texCoord * 3.0 + vec2(u_time * 0.15));
    float n2 = snoise(v_texCoord * 6.0 - vec2(u_time * 0.08));
